export function criarCameraRotativa(camera, alvo){
    ...
    document.addEventListener('pointermove',(e)=>{
        ...
        rotacaoY -= (e.clientX - ultimoX) * 0.008;
        rotacaoX -= (e.clientY - ultimoY) * 0.006;
    ...
    document.addEventListener('pointerup',(e)=>{
        if(e.pointerId === ponteiroCamera) ponteiroCamera = null;
    });
    ...
    function atualizar(){
        ...
        camera.position.set(x, alvo.position.y + altura, z);
